...
export default {
  ...
  [CODE.node_verify_code_fail]: 'Something’s not right. Please send an email to go@incognito.org so we can assist you directly.',
  [CODE.node_create_account_fail]: 'Something went wrong. Please close the app and try again.',
  [CODE.node_can_not_connect_hotspot]: 'Something went wrong. Please open Wi-Fi settings on your device and connect to Node again.',
